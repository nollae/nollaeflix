...
import { useResetAllStates } from '../atoms';
...
const NavItemWrapper = styled.li<{$isMatched?:boolean}>`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    color: #fff;
    cursor: default;
...
const NavItemsContainer2 = styled.div`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    color: #fff;
    cursor: default;
...
const NavItemWrapper2 = styled.div`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    color: #fff;
    cursor: default;
...
const SearchButton = styled(motion.button)<{$isOpen:boolean}>`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    user-select: none;
    word-break: keep-all;
...
const SearchInputContainer = styled(motion.div)<{$isOpen:boolean}>`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    color: #fff;
    cursor: default;
...
// const SearchCloseButton = styled(motion.span)`
//     -webkit-text-size-adjust: 100%;
//     -webkit-font-smoothing: antialiased;
//     color: #fff;
//     user-select: none;
...
const AccountButtonWrapper = styled.a`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    user-select: none;
    word-break: keep-all;
...
const AccountCaret = styled.span<{$isOpen:boolean}>`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    color: #fff;
    user-select: none;
...
// const AccountMenuContainer = styled.ul`
//     -webkit-text-size-adjust: 100%;
//     -webkit-font-smoothing: antialiased;
//     user-select: none;
//     word-break: keep-all;
...
const LogoutContainer = styled.ul`
    -webkit-text-size-adjust: 100%;
    -webkit-font-smoothing: antialiased;
    user-select: none;
    word-break: keep-all;
                ...
                <HeaderContainer>
                    ...
                    <HomeHeaderContainer>
                        ...
                        <NavItemsContainer>
                            ...
                            <NavItemWrapper $isMatched={homeMatch?.isExact}>
                                <Link to="/home">
                                    홈 {homeMatch?.isExact}
                                </Link>
                            </NavItemWrapper>
                            <NavItemWrapper $isMatched={seriesMatch?.isExact}>
                                <Link to="/home/series">
                                    시리즈 {seriesMatch?.isExact}
                                </Link>
                            </NavItemWrapper>
                            <NavItemWrapper $isMatched={wishMatch?.isExact}>
                                <Link to="/home/wish">
                                    내가 찜한 리스트 {wishMatch?.isExact}
                                </Link>
                            </NavItemWrapper>
                            {/* <NavItemWrapper $isMatched={likeMatch?.isExact}>
                                <Link to="/home/like">
                        ...
                        <NavItemsContainer2>
                            ...
                            {/* Account */}
                            <NavItemWrapper2 onClick={handleDropDown}> 
                                <AccountWrapper>
                                    <AccountDropDownWrapper>
                                        ...
                                        <AccountCaret $isOpen={isOpenDrop} />
                                    </AccountDropDownWrapper>
                                    {/* menu */}
                                    <MenuWrapper $isOpen={isOpenDrop}>
                                        <MenuContainer>
                                            {/* <MenuBlock /> */}
                                            {/* About Account */}
                                            {/* <AccountMenuContainer> */}
                                                ...
                                                {/* <MenuItemWrapper>
                                                    <MenuItem>
                                                        ...
                                                        <MenuItemTitle>프로필 관리</MenuItemTitle>
                                                    </MenuItem>
                                                </MenuItemWrapper> */}
                                                {/* 계정 */}
                                                {/* <MenuItemWrapper>
                                                    <MenuItem>
                                                        ...
                                                        <MenuItemTitle>계정</MenuItemTitle>
                                                    </MenuItem>
                                                </MenuItemWrapper> */}
                                                {/* 고객 센터 */}
                                                {/* <MenuItemWrapper>
                                                    <MenuItem>
                                                        ...
                                                        <MenuItemTitle>고객 센터</MenuItemTitle>
                                                    </MenuItem>
                                                </MenuItemWrapper> */}
                                            {/* </AccountMenuContainer> */}
                                            {/* Logout */}
